...
CREATE TABLE "grape_varietals" (
    ...
    CONSTRAINT "grape_varietals_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "product_varietals" (
    ...
    CONSTRAINT "product_varietals_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "product_varietals" ADD CONSTRAINT "product_varietals_productId_fkey" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "product_varietals" ADD CONSTRAINT "product_varietals_varietalId_fkey" FOREIGN KEY ("varietalId") REFERENCES "grape_varietals"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "inventory_logs" ADD CONSTRAINT "inventory_logs_adminUserId_fkey" FOREIGN KEY ("adminUserId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
